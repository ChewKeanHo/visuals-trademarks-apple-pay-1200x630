# Apple Pay's Trademark Logo 1200x630 | (Holloway) Chew, Kean Ho's Creative Visuals

[![logo](/share/icons/chewkeanho/trademarks/apple-pay_1200x630.svg)](#)

The Apple Pay's Trademark Logo. They published clear trademark guideline and
...
This project re-draws Apple Pay's Trademark Logo specifically for 1200x630 size.
...
2. Since Apple Pay published its trademark guidelines, you **MUST** go through
   the following specifications to avoid any unwanted legal implications:
...
4. While not specified by Apple Pay; please ensures the outputs are web-ready.
   Refer:
...
> STILL OBLIGATED TO COMPLY WITH APPLE PAY'S TRADEMARK REQUIREMENTS
> (refer: https://developer.apple.com/apple-pay/marketing)**.
>
...
SKU: chewkeanho-visuals-trademarks-apple-pay-1200x630
UUID: B49449E8-CF40-465E-B758-F224ABE75638
...
Repository Made On: 2026-08-20
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-trademarks-apple-pay-1200x630
```
